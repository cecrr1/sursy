...
API_ID = int(getenv("API_ID",21159171""))
API_HASH = getenv("API_HASH","c190a08adac4e40dafa170255fd15b2a")

# Get your token from @BotFather on Telegram.
BOT_TOKEN = getenv("BOT_TOKEN","7142077745:AAFXCrNNDTNcafUWHIbGdI0Gj9tgGxkg-b8")
...
OWNER_ID = int(getenv("OWNER_ID",6207674867 ))
